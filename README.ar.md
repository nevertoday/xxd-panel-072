...
# 🦁 XXD Panel 072｜دفتر الألوان الزاهية

### ينقّي الصور إلى نظام تجريدي متعدد الطبقات من الزجاج المصنفر
...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 072 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.
...
يختزل **Panel 072** أكثر المحيطات والبنى والوضعيات والعلاقات قابلية للتعرف إلى هندسة بسيطة ومساحات لونية مسطحة وخطوط رفيعة، ثم يبني نوافذ نصف شفافة مصنفرة تختلف قوتها من منطقة إلى أخرى. تتعايش الأجزاء الواضحة والناعمة والمتراكبة بشفافية، ويبقى العنصر قابلًا للتعرف فورًا وهو معلق في حقل فاتح هادئ. تضيف الكتابة الحديثة المقتصدة نظامًا قريبًا من الملصقات المعمارية ورسوم المعارض.

### مناسب لـ

- زجاج مصنفر بلا إحساس المرشح، حيث يُصمَّم الضباب بحسب المناطق والطبقات بدلاً من تمويه اللوحة كلها بالتساوي؛
- تجريد يبقى قابلاً للتعرّف من النظرة الأولى، فلا تبتلع الزخرفة المحيط والبنية والوضعيّة والعلاقة السردية الأساسية؛
- نظام بصري حديث تبنيه الموازنة المركزية والأشكال الموجبة والسالبة والفراغ وخطوط التكوين والكتابة المقتصدة؛
- مخرجات أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وحزم خلفيات ومعالجة المجلدات.

### بداية سريعة

> استخدم XXD Panel 072 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** نوافذ مصنفرة نصف شفافة · تركيز ناعم بحسب المنطقة · هندسة بسيطة · محيط قابل للتعرف · لون مشرق ومريح · كتابة تحريرية حديثة
...
|---|---|
| **الناتج** | ملصق تجريدي راقٍ وحديث من الزجاج المصنفر يجمع وضوح الهوية مع جو ضبابي |
| **البصمة الواضحة** | عنصر هندسي معلق في فراغ واسع، ومناطق مختلفة من التركيز الناعم والتراكب الشفاف والحواف الواضحة |
| **احترام المصدر** | يحافظ على المحيط والبنية والوضعية والعلاقة، ثم يضيء هوية ألوان المصدر وينظفها ويلينها |
...
```text
تثبيت المحيط والبنية والوضعية والعلاقة السردية → حذف التفاصيل الواقعية → تلخيصها بهندسة مسطحة وخطوط رفيعة → بناء طبقات مصنفرة وناعمة وشفافة مختلفة بحسب المنطقة → الحفاظ على هوية لون المصدر مع إضاءته وتنظيفه → توسيط العنصر في فراغ فاتح واسع → إضافة كتابة تحريرية حديثة مقتصدة
```

## سمات النتيجة النهائية

- يلخص العنصر بهندسة بسيطة ومساحات مسطحة وخطوط رفيعة وفراغ واسع مع الحفاظ على سماته التعريفية.
- يمنح الضبابية وفقدان التركيز والتراكب الشفاف فروقًا واضحة بين المناطق وطبقات هرمية، لا تأثيرًا موحدًا.
- يستخدم التوسيط والشكل الموجب والسالب والحجم والفراغ الفاتح لصنع إحساس هادئ بالتعليق.
- يحافظ على هوية لون المصدر ثم يرفع الإضاءة والنقاء ويزيل الرمادية وينظف اللون ويلينه.
- تبقى الكتابة قليلة وحديثة ودقيقة، قريبة من ملصقات العمارة وأنظمة تحرير المعارض.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-072-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 072. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-072 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-072 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-072 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-072 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-072 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 072 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-072 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-072`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-072-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-072-prompt.zh-CN.md)

<!-- xxd-panel-catalog:start -->
## دليل مشاريع XXD Panel الكامل

يحافظ كل مشروع من مشاريع Panel الـ72 على موجّهه الأصلي ومنطقه الجمالي المستقل. يسرد الجدول المشاريع من 001 إلى 072 دون أرقام مفقودة، مع تمييز المشروع الحالي بخط عريض.
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–072) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
