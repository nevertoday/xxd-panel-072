...
```text
/xxd-panel-072 <source-or-directory> --mode top-bottom,design-only \
...
1. 上下对照（原图在上，072 设计在下）
2. 左右对照（原图在左，072 设计在右）
...
```text
~/Desktop/xxd/xxd-panel-072/<fresh-task>/
...
- `references/xxd-panel-072-prompt.zh-CN.md`
- `references/xxd-panel-072-prompt.en.md`
